...
CREATE TABLE "InternalAuditRisk" (
    ...
    "operationalRisk" INTEGER,
    "itDataRisk" INTEGER,
    "controlEffectivenessScore" INTEGER,
    "assessmentStatus" TEXT NOT NULL DEFAULT 'Not Assessed',
    "assessmentLikelihood" INTEGER,
    "assessmentResidualScore" DOUBLE PRECISION,
    "engagementId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "AuditReport" (
    ...
    "topMessages" TEXT,
    "keyRisks" TEXT,
    "summaryKeyFindings" TEXT,
    "mgmtAttentionImmediate" TEXT,
    "mgmtAttentionMediumTerm" TEXT,
    "followUp" TEXT,
    "overallResult" TEXT,
    "status" TEXT NOT NULL DEFAULT 'Draft',
...
CREATE TABLE "AuditDeclaration" (
    ...
    CONSTRAINT "AuditDeclaration_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "AuditFindingsDiscussionMeeting" (
    "id" TEXT NOT NULL,
    "customerAccountId" TEXT NOT NULL,
    "engagementId" TEXT NOT NULL,
    "meetingVenue" TEXT,
    ...
    CONSTRAINT "AuditFindingsDiscussionMeeting_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "AuditClosingMeeting" (
    "id" TEXT NOT NULL,
    "customerAccountId" TEXT NOT NULL,
    "engagementId" TEXT NOT NULL,
    "meetingVenue" TEXT,
    ...
    CONSTRAINT "AuditClosingMeeting_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "AuditOpeningMeeting" (
    "id" TEXT NOT NULL,
    "customerAccountId" TEXT NOT NULL,
    "engagementId" TEXT NOT NULL,
    "meetingVenue" TEXT,
    ...
    CONSTRAINT "AuditOpeningMeeting_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "AuditCharter" (
    ...
    "signedCopyData" BYTEA,
    "signedCopyMimeType" TEXT,
    "signedCopyUploadedAt" TIMESTAMP(3),

    CONSTRAINT "AuditCharter_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "AuditDeclaration_customerAccountId_idx" ON "AuditDeclaration"("customerAccountId");

-- CreateIndex
CREATE UNIQUE INDEX "AuditDeclaration_customerAccountId_declarationCode_key" ON "AuditDeclaration"("customerAccountId", "declarationCode");
...
-- CreateIndex
CREATE UNIQUE INDEX "AuditFindingsDiscussionMeeting_engagementId_key" ON "AuditFindingsDiscussionMeeting"("engagementId");

-- CreateIndex
CREATE INDEX "AuditFindingsDiscussionMeeting_customerAccountId_idx" ON "AuditFindingsDiscussionMeeting"("customerAccountId");

-- CreateIndex
CREATE UNIQUE INDEX "AuditClosingMeeting_engagementId_key" ON "AuditClosingMeeting"("engagementId");

-- CreateIndex
CREATE INDEX "AuditClosingMeeting_customerAccountId_idx" ON "AuditClosingMeeting"("customerAccountId");

-- CreateIndex
CREATE UNIQUE INDEX "AuditOpeningMeeting_engagementId_key" ON "AuditOpeningMeeting"("engagementId");
...
-- CreateIndex
CREATE UNIQUE INDEX "AuditCharter_customerAccountId_key" ON "AuditCharter"("customerAccountId");
...
-- AddForeignKey
ALTER TABLE "InternalAuditProcess" ADD CONSTRAINT "InternalAuditProcess_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "AuditCategory"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AuditEngagement" ADD CONSTRAINT "AuditEngagement_auditCategoryId_fkey" FOREIGN KEY ("auditCategoryId") REFERENCES "AuditCategory"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AuditCharter" ADD CONSTRAINT "AuditCharter_customerAccountId_fkey" FOREIGN KEY ("customerAccountId") REFERENCES "CustomerAccount"("id") ON DELETE CASCADE ON UPDATE CASCADE;
