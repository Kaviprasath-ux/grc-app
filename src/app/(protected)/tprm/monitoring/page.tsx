...
// Generate simulated monitoring scores for vendors (placeholder until real scanning API is connected)
function generateMonitoringData(vendors: Vendor[]): MonitoringEntry[] {
  return vendors.map((v) => {
    // Deterministic seed from vendor id for consistent results
