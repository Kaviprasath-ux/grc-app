          ...
          <CardContent>
            {linkedControls.length === 0 ? (
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p>No controls linked to this {policy.type.toLowerCase()}</p>
              </div>
            ) : (
              <Table>
                <TableHeader>
          ...
          <CardContent>
            {linkedExceptions.length === 0 ? (
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p>No exceptions linked to this {policy.type.toLowerCase()}</p>
              </div>
            ) : (
              <Table>
                <TableHeader>
        ...
        <Card>
          ...
          <CardContent>
            {linkedDocuments.length === 0 ? (
              <div className="text-center py-8 text-muted-foreground">
                <FileText className="h-12 w-12 mx-auto mb-2 opacity-50" />
                <p>No documents linked to this {policy.type.toLowerCase()}</p>
              </div>
            ) : (
              <Table>
                <TableHeader>
