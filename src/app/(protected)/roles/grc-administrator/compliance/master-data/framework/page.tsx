        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
          ...
          <Dialog open={aiDialogOpen} onOpenChange={setAiDialogOpen}>
            <DialogTrigger asChild>
              <Button variant="outline" size="sm" className="w-full sm:w-auto bg-primary-50 hover:bg-primary-100 text-primary-700 border-primary-200">
      ...
      <div className="bg-white rounded-xl border border-slate-200">
        ...
        <Table className="min-w-[600px]">
          <TableHeader>
            <TableRow className="border-b border-slate-100 bg-slate-50/50">
              <TableHead className="text-xs font-semibold text-slate-600 h-12 ltr:pl-4 rtl:pr-4">{t("Framework Name")}</TableHead>
              ...
              <TableHead className="text-xs font-semibold text-slate-600 h-12 ltr:pr-4 rtl:pl-4 w-[100px]">{t("Action")}</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {paginatedFrameworks.length === 0 ? (
                ...
                <TableCell colSpan={4} className="py-0">
                  <div className="py-16 text-center">
                    ...
                    <p className="text-sm text-slate-500">
                      {t("Create a new framework to get started.")}
                    </p>
                  </div>
                </TableCell>
              </TableRow>
              ...
              paginatedFrameworks.map((framework) => (
                <TableRow key={framework.id} className="border-b border-slate-100 last:border-0 hover:bg-slate-50">
                  <TableCell className="py-3 text-sm font-medium text-slate-800 ltr:pl-4 rtl:pr-4">
                    {framework.name}
                  </TableCell>
                  ...
                  <TableCell className="py-3 text-sm ltr:pr-4 rtl:pl-4">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-slate-100">
          ...
          <div className="flex items-center gap-1">
            ...
            >
              <ChevronsLeft className="h-4 w-4 ltr:rotate-0 rtl:rotate-180" />
            </Button>
            <Button
              variant="ghost"
              size="icon"
            ...
            <Button
              ...
              disabled={currentPage >= totalPages}
            >
              <ChevronsRight className="h-4 w-4 ltr:rotate-0 rtl:rotate-180" />
            </Button>
          </div>
        </div>
      </div>
