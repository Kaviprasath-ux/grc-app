    ...
    return (
      <div className="space-y-6">
        ...
        <nav className="flex items-center gap-1.5 text-sm">
          ...
          <ChevronRight className="h-3.5 w-3.5 text-slate-300" />
          <span className="text-primary-700 font-medium">Audit Category</span>
        </nav>

        <h1 className="text-2xl font-bold text-slate-800">Audit Category</h1>
      ...
      <div className="bg-white rounded-xl border border-slate-200">
        <Table>
          <TableHeader>
            <TableRow className="border-b border-slate-100 bg-slate-50/50">
              <TableHead className="text-xs font-semibold text-slate-600 h-12 pl-4">Category Name</TableHead>
          ...
          <TableBody>
            {paginatedCategories.length === 0 ? (
              ...
              paginatedCategories.map((category) => (
                <TableRow key={category.id} className="border-b border-slate-100 last:border-0 hover:bg-slate-50">
                  <TableCell className="py-3 text-sm font-medium text-slate-800 pl-4">{category.name}</TableCell>
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-slate-100">
          <span className="text-sm text-slate-500">
            {totalItems > 0 ? `${startItem} to ${endItem} of ${totalItems}` : "No categories"}
          </span>
          <div className="flex items-center gap-1">
            <Button
              variant="ghost"
