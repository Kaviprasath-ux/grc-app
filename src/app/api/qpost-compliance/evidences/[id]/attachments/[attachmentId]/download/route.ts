...
// GET /api/qpost-compliance/evidences/[id]/attachments/[attachmentId]/download - Download a QPost evidence attachment
export const GET = withAuth(
  async (req, context: RouteContext, session) => {
    try {
      ...
      console.error("Error downloading QPost evidence attachment:", error);
      return NextResponse.json(
