...
export async function POST(req: NextRequest) {
  try {
    ...
    let body: { department_name?: string; risks?: Array<{ associated_risk: string; risks_level: string }>; CAPA?: Array<{ finding_name: string; audit_title: string; severity: string }> };
    try {
    ...
    const { department_name, risks, CAPA } = body;
