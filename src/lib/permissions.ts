...
export const RESOURCES = {
  ...
  'compliance.technical-evidence': '/compliance/technical-evidence',
  'compliance.integration-credentials': '/compliance/technical-evidence/settings',
...
export const ROLE_PERMISSIONS: Record<RoleName, RolePermissionDef[]> = {
  ...
  GRCAdministrator: [
    ...
    { resource: 'compliance.technical-evidence', actions: ['*'], scope: 'all' },
    { resource: 'compliance.integration-credentials', actions: ['*'], scope: 'all' },
  ...
  Reviewer: [
    ...
    { resource: 'compliance.technical-evidence', actions: ['view', 'create', 'edit', 'delete'], scope: 'all' },
    { resource: 'compliance.integration-credentials', actions: ['view', 'create', 'edit', 'delete'], scope: 'all' },
  ...
  Contributor: [
    ...
    { resource: 'compliance.technical-evidence', actions: ['view', 'create', 'edit'], scope: 'all' },
  ...
  DepartmentReviewer: [
    ...
    { resource: 'compliance.technical-evidence', actions: ['view'], scope: 'department' },
  ...
  DepartmentContributor: [
    ...
    { resource: 'compliance.technical-evidence', actions: ['view', 'create', 'edit'], scope: 'department' },
