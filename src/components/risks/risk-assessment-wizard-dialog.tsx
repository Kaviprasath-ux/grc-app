    ...
    try {
      await fetch(`/api/risks/${risk.id}`, {
        ...
        body: JSON.stringify({
          ...
          inherentRiskScore: riskScoreCalc,
    ...
    try {
      await fetch(`/api/risks/${risk.id}`, {
        ...
        body: JSON.stringify({
          ...
          ...(responseNeeded && { responseStatus: "Open" }),
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-[95vw] sm:max-w-[700px] h-[85vh] flex flex-col p-0 gap-0 overflow-hidden" showCloseButton={false}>
          {/* Fixed Header */}
