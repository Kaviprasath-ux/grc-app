  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] flex flex-col p-0 gap-0">
        <DialogHeader className="flex-shrink-0 px-6 py-4 border-b border-slate-100">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <button
                        onClick={() => setCurrentStep(step.id)}
                        className={cn(
                          "ltr:ml-3 rtl:mr-3 text-sm font-medium",
                          currentStep >= step.id
                            ? "text-primary-600"
                            : "text-slate-500"
                        )}
                      ...
                      {index !== steps.length - 1 && (
                        <div
                          className={cn(
                            "ltr:ml-4 rtl:mr-4 h-0.5 flex-1",
          ...
          <div className="min-h-[420px]">
            ...
            {currentStep === 1 && (
              <div className="space-y-6">
                <h3 className="text-lg font-semibold text-slate-800 mb-1">{isEditMode ? "Edit Risk" : "Risk Details"}</h3>
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                <div className="flex items-center justify-between border-b border-slate-200 pb-3">
                  ...
                  <Button variant="outline" size="sm" onClick={() => setLinkControlDialogOpen(true)}>
        ...
        <div className="flex-shrink-0 flex items-center gap-3 px-6 py-4 border-t border-slate-100 bg-slate-50/80 rounded-b-lg">
          <span className="text-xs font-medium text-slate-500 ltr:mr-auto rtl:ml-auto">
          ...
          >
            {currentStep > 1 && <ChevronLeft className="h-4 w-4 ltr:mr-2 rtl:ml-2" />}
